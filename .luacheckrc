...
do -- Setup
	...
	do -- Stdlib Files
		local stdlib_control =
			{ std = "lua52+factorio+factorio_control+stdlib+factorio_defines", max_line_length = LINE_LENGTH }
		local stdlib_data =
			{ std = "lua52+factorio+factorio_data+stdlib+factorio_defines", max_line_length = LINE_LENGTH }
	...
	do -- local vars
		...
		LuaCommandProcessor = {
			fields = {
				...
				game_commands = { other_fields = true },
			},
		}
...
do -- Factorio Base and Core mod STDs
	...
	stds.factorio_base_scenarios = {
		globals = {
			...
			"entities",
			"stop",
			"get_spawn_coordinate", -- tutorials
			"intermission",
...
do -- STDLIB
	...
	stds.stdlib_love = {
		read_globals = {
			love = {
				fields = {
					arg = { fields = { "parseGameArguments", "parseOption", "getLow", "optionIndices", "options" } },
				},
			},
			"coroutine",
			"io",
	...
	read_globals = {
		defines = {
			fields = {
				...
				build_check_type = {
					fields = { "blueprint_ghost", "ghost_revive", "manual", "manual_ghost", "script", "script_ghost" },
				},
				chain_signal_state = { fields = { "all_open", "none", "none_open", "partially_open" } },
				chunk_generated_status = {
					fields = { "basic_tiles", "corrected_tiles", "custom_tiles", "entities", "nothing", "tiles" },
				},
				...
				control_behavior = {
					fields = {
						...
						mining_drill = {
							fields = { resource_read_mode = { fields = { "entire_patch", "this_miner" } } },
						},
				...
				direction = {
					fields = { "east", "north", "northeast", "northwest", "south", "southeast", "southwest", "west" },
				},
				disconnect_reason = {
					fields = {
						"afk",
				...
				logistic_mode = {
					fields = { "active_provider", "buffer", "none", "passive_provider", "requester", "storage" },
				},
